...
<head>
  ...
  <div class="card-body">
    <h5 class="card-title">View existing quiz</h5>
  ...
  <div class="card-body">
    <h5 class="card-title">View Score</h5>
    <form method="post" action="viewsc">
  <div class="form-group">
    
    <input type="number" class="form-control" id="uid" name="uid" value="<%=uid  %>" readonly="yes" hidden>
  </div>
   <button type="submit" class="btn btn-primary">Check/View</button>
</form>
