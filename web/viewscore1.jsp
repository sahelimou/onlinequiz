...
<html>
    ...
    <body>
     ...
     <div class="col">
     <label for="qid">Total mark</label>
     <input type="text" class="form-control" id="q_mark" name="q_mark" value="<%=qb.getTot_m() %>"  readonly="yes" ></div>
     <div class="col">
     <label for="qid">Marks obtained</label>
     <input type="text" class="form-control" id="tot_tm" name="tot_tm" value="<%=qb.getQmark() %>"  readonly="yes" ></div>
                                               </div>
    <%} %>
    </div>
  </div>
